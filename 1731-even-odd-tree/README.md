<h2><a href="https://leetcode.com/problems/even-odd-tree">1731. Even Odd Tree</a></h2><p>A binary tree is named <strong>Even-Odd</strong> if it meets the following conditions:</p>
